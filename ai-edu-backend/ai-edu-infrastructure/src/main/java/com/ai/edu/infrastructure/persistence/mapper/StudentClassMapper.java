...
public interface StudentClassMapper extends BaseMapper<StudentClass> {
    ...
    Optional<StudentClass> selectActiveByStudentId(Long studentId);
    ...
    List<StudentClass> selectActiveByClassId(Long classId);
    ...
    List<StudentClass> selectByStatus(String status);
