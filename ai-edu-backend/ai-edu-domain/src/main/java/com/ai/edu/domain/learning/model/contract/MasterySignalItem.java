...
/**
 * 掌握度信号项（mastery_signals 单项：{kp_label, signal}，Java↔Python 内部契约 snake_case）。
 *
 * <p>signal 为 Python 原始小写字符串（mastered/practicing/struggling），
...
public class MasterySignalItem implements Serializable {
    ...
    /** 知识点 label（Python label 接地：优先复用快照候选） */
